...
describe('contractPoint utils', () => {
  ...
  it.only('should', function () {
    ...
    const scaleShiftXyContour = coordinatesLib.polygonShift(xyContour, 1, 1, 0, 1.5);
    assert.deepEqual(shiftXyContour, [ [ 2, 2 ], [ 2, 9.5 ], [ 9.5, 9.5 ], [ 9.5, 2 ] ]);
    console.log('scaleShiftXyContour', scaleShiftXyContour);
    ...
    const shiftContour = contractPoint.shiftContour(contour, 5.1, 1);
    console.log('shiftContour', shiftContour);
  });
});
